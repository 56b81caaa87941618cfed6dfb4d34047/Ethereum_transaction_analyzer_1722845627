...
*/
Vue.component("simple_footer_component_1722845630", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10 rounded-lg shadow-lg">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-white">
                        Gain real-time insights into the latest Ethereum transactions. EtherScan empowers you to monitor, analyze, and stay ahead of the ever-evolving Ethereum network.
                    </div>
                </div>
            </div>
        </footer> 
